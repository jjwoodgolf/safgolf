...
const ProgramsPage = () => {
  const programs = [
    ...
    },
    {
      ...
      features: ["Game Evaluation From College Coaches In Each Area Of The Game", "College Recruiting Workshop, Q&A With College Coaches", "Video highlights", "Networking opportunities"],
    },
    {
      icon: UserCheck,
